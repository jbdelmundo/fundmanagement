	...
	<div class="row">
			<div class="col-md-6 text-right">
				...
				<div class="input-group custom-search-form">
					{!! Form::text('subject', Request::get('subject'), ['class' => 'form-control', 'placeholder' => 'Search Subject']) !!}
...
<div class="panel panel-default">
    <div class="panel-heading">
	  	Purchases for {{$department->short_name}} in AYSEM {{$aysem->short_name}}
    </div>
@if(((count($purchased['B']))+(count($purchased['E']))+(count($purchased['M']))+(count($purchased['J']))+(count($purchased['Q']))+(count($purchased['S']))+(count($purchased['O'])))>0)
